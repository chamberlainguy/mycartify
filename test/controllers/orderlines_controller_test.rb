...
class OrderlinesControllerTest < ActionController::TestCase
  ...
  test "should create orderline" do
    assert_difference('Orderline.count') do
      post :create, orderline: { order_id: @orderline.order_id, product_id: @orderline.product_id, product_name: @orderline.product_name, quantity: @orderline.quantity, total_price: @orderline.total_price }
    end
  ...
  test "should update orderline" do
    patch :update, id: @orderline, orderline: { order_id: @orderline.order_id, product_id: @orderline.product_id, product_name: @orderline.product_name, quantity: @orderline.quantity, total_price: @orderline.total_price }
    assert_redirected_to orderline_path(assigns(:orderline))
  end
